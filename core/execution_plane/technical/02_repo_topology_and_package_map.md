...
/home/home/p/g/n/execution_plane
  /mix.exs                                  # non-published Blitz workspace
  /core/execution_plane                     # publishable execution_plane package
  /core/execution_plane/core/execution_plane_contracts
  /core/execution_plane/core/execution_plane_kernel
  /core/execution_plane/placements/execution_plane_local
  /core/execution_plane/placements/execution_plane_ssh
  /core/execution_plane/placements/execution_plane_guest
  /core/execution_plane/conformance/execution_plane_testkit
...
- `core/execution_plane/mix.exs`: `execution_plane` common substrate package
...
The repository root `mix.exs` is `execution_plane_workspace`, a non-published
tooling project that owns Blitz orchestration and root docs only.
...
They must document isolation strength honestly. The current common substrate
has no sandbox backend behaviour; it carries opaque sandbox profiles and
...
## Active Common Package Scope

The `core/execution_plane` Mix package compiles common substrate homes only:
...
`execution_plane` package but does not require any lane package. Hosts choose
lanes by declaring lane deps and registering adapters.
