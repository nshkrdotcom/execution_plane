defmodule ExecutionPlane.Process.Transport.SSHExecTest do
  ...
  test "start/1 streams over the SSH surface and exposes generic plus adapter metadata" do
    ...
    assert_receive {:execution_plane_process, ^ref, {:data, "ssh:alpha\n"}}, 2_000
  ...
  test "interrupt/1 propagates through the SSH surface" do
    ...
    assert_receive {:execution_plane_process, ^ref, {:stderr, "interrupted\n"}}, 2_000
