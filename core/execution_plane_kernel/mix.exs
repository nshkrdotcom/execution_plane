defmodule ExecutionPlaneKernel.MixProject do
  use Mix.Project
  ...
  def project do
    [
      app: :execution_plane_kernel,
      name: "ExecutionPlaneKernel",
      version: @version,
      elixir: "~> 1.18",
      start_permanent: Mix.env() == :prod,
      description:
        "Execution Plane dispatch kernel, route validation, and lower simulation support.",
      package: package(),
      docs: docs(),
      dialyzer: dialyzer(),
      deps: deps(),
  ...
  defp execution_plane_contracts_dep do
    case workspace_dep_path("../execution_plane_contracts") do
