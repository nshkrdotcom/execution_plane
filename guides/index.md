...
The root package compiles these common source homes:
...
in their package-local Mix projects. The retired
`core/execution_plane_contracts`, `core/execution_plane_kernel`, and
`placements/execution_plane_local` Mix roots are source homes only.
