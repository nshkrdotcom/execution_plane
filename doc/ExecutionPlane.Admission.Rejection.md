# `ExecutionPlane.Admission.Rejection`
[🔗](https://github.com/nshkrdotcom/execution_plane/blob/v0.1.0/lib/execution_plane/boundary.ex#L583)
...
```elixir
@type t() :: %ExecutionPlane.Admission.Rejection{
