# `ExecutionPlane.Runtime.Constraint`
[🔗](https://github.com/nshkrdotcom/execution_plane/blob/v0.1.0/lib/execution_plane/boundary.ex#L366)

Serializable runtime constraint.

# `t`

```elixir
@type t() :: %ExecutionPlane.Runtime.Constraint{
