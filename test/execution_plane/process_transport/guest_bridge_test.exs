defmodule ExecutionPlane.Process.Transport.GuestBridgeTest do
  ...
  test "start/1 streams over the guest bridge and exposes bridge metadata" do
    ...
    assert_receive {:execution_plane_process, ^ref, {:data, "guest-session:alpha"}}, 2_000
    assert_receive {:execution_plane_process, ^ref, {:stderr, "guest-session-stderr\n"}}, 2_000
