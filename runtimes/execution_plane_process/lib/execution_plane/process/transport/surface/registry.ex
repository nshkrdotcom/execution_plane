defmodule ExecutionPlane.Process.Transport.Surface.Registry do
  @moduledoc """
  ...
  @optional_adapters %{
    test_guest_local: ExecutionPlane.TestSupport.GuestLocalAdapter,
    test_restricted_spawn: ExecutionPlane.TestSupport.RestrictedSpawnAdapter
  }
